...
public final class TesteEscoltadorDeTestesExecucaoDoisAcessoriosPassandoPassandoUmTestePassando {

	private Iterator<Notificacao> notificacoes;

	@Before
	public void prepararCenario() {
		SuiteDeTeste suite = new SuiteDeTeste(DoisAcessoriosPassandoPassandoUmTestePassando.class);
	...
	public void testar() throws Exception {
		assertThat(notificacoes.next(), combinaComTestesIniciados(DoisAcessoriosPassandoPassandoUmTestePassando.class));
		assertThat(notificacoes.next(), combinaComTesteIniciado(DoisAcessoriosPassandoPassandoUmTestePassando.class, "testar"));
		assertThat(notificacoes.next(), combinaComTesteFinalizado(DoisAcessoriosPassandoPassandoUmTestePassando.class, "testar"));
