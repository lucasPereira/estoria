...
public final class TesteEscoltadorDeTestesExecucaoUmBeforePassandoUmTesteFalhando {
	...
	public void testar() throws Exception {
		...
		assertThat(notificacoes.get(1), combinaComTesteIniciado(UmBeforePassandoUmTesteFalhando.class, "testarDeTesteFalhando"));
		assertThat(notificacoes.get(2), combinaComTesteFalha(UmBeforePassandoUmTesteFalhando.class, "testarDeTesteFalhando", AssertionError.class));
		assertThat(notificacoes.get(3), combinaComTesteFinalizado(UmBeforePassandoUmTesteFalhando.class, "testarDeTesteFalhando"));
